...
const mockAuditLogs = [
    { id: 'AUD-001', timestamp: '2025-02-22T10:15:32Z', user: 'Moussa Diallo', role: 'Advisor', category: 'trading', severity: 'info', action: 'Ordre exécuté', detail: 'Achat 500 parts VXUS pour le compte C002 (Ousmane N\'Diaye). Montant : 28 750 FCFA. Ordre au marché.', ip: '192.168.1.42', sessionId: 'SES-8a7f3d' },
    ...
    { id: 'AUD-006', timestamp: '2025-02-22T09:45:00Z', user: 'Diambar AI', role: 'IA', category: 'trading', severity: 'info', action: 'TLH exécuté', detail: 'Tax-Loss Harvesting automatique : vente VTI (-2 340 FCFA perte réalisée) et achat ITOT pour C007 (Cheikh K. Ba). Économie fiscale estimée : 936 FCFA.', ip: 'system', sessionId: 'AI-tlh-auto' },
