...
const mockNotifications = [
    // Critiques
    { id: 'n1', category: 'trading', priority: 'critical', title: 'Ordre exécuté — AAPL', description: 'Rééquilibrage Ousmane N\'Diaye : 150 parts AAPL achetées à 228,50 $. Total : 34 275 $.', time: '2025-02-22T09:30:00', read: false, icon: TrendingUp, color: 'var(--kd-success)', actionLabel: 'Voir l\'ordre', actionLink: '/trading' },
    ...
    // Moyennes
    { id: 'n6', category: 'billing', priority: 'medium', title: 'Prochain cycle de facturation', description: 'La facturation T1 pour 142 ménages est programmée pour le 1er avril. Montant estimé : 458 250 $.', time: '2025-02-21T17:00:00', read: true, icon: DollarSign, color: 'var(--kd-copper)', actionLabel: 'Voir la facturation', actionLink: '/billing' },
    ...
    { id: 'n8', category: 'trading', priority: 'medium', title: 'Ordre en attente d\'approbation', description: 'Cheikh K. Ba — Achat 100 parts AMZN à 215,80 $. En attente de validation du conseiller.', time: '2025-02-21T11:00:00', read: true, icon: Clock, color: 'var(--kd-warning)', actionLabel: 'Approuver', actionLink: '/trading' },
    // Informatives
